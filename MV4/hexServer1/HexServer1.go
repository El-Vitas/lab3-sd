...
import (
	...
	pb2 "hexServer1/generated/hex_s"
	pb "hexServer1/generated/hextech"
...
var servers = []string{"dist102:50052", "dist103:50053"}
var numServer = 0
...
func (s *server) GetData(ctx context.Context, req *pb2.GetDataRequest) (*pb2.GetDataResponse, error) {
	...
	log.Printf("Datos enviados: Región=%s, Producto=%s, Valor=%d, VectorClock=%v", region, product, productValue, s.regions[region])
	return response, nil
}
